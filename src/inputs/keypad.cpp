...
char *commandMap[5][4] = {
    {"$J=G91 G21 X3000", "$J=G91 G21 Y3000 F1000", "$J=G91 G21 Z1000 F1000", "$J=G91 G21 A1000 F1000"},
    {"$J=G91 G21 X-3000", "$J=G91 G21 Y-3000 F1000", "$J=G91 G21 Z-1000 F1000", "$J=G91 G21 A-1000 F1000"},
    {"", "", "", ""},
    {"", "", "", ""},
    {"", "", "", ""},
};
